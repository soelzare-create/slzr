...
export const api = {
  ...
  updateDocument: (id, d) => request(`/accounting/documents/${id}`, { method: "PATCH", body: d }),
  deleteDocument: (id) => request(`/accounting/documents/${id}`, { method: "DELETE" }),
  listPayments: (params) => request(`/accounting/payments${qs(params)}`),
  createPayment: (p) => request("/accounting/payments", { method: "POST", body: p }),
  updatePayment: (id, p) => request(`/accounting/payments/${id}`, { method: "PATCH", body: p }),
  deletePayment: (id) => request(`/accounting/payments/${id}`, { method: "DELETE" }),
